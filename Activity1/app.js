...
const {title,title2, para,para2, button1,button2,button3,button4, image} = data
let container = document.getElementById("container")
container.append(leftdiv(title,title2, para,para2, button1,button2,button3,button4))
